  ...
  const handleCancel = () => {
    ...
    return (
        ...
        <Card.Body>
          ...
          <Card.Text>
          <Form.Control type="text" placeholder="Enter Label" className="formControl" value={props.textField.label} onChange={(e)=>handleChangeLabel(e)}/>
          <Form.Control type="text" placeholder="Enter Placeholder" className="formControl" value={props.textField.placeholder} onChange={(e)=>handleChangePlaceholder(e)}/>
          <Form.Check
            type='checkbox'
            id="default-checkbox"
            label="Required"
            className="required"
            checked={props.textField.required}
